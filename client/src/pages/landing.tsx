    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="flex-1 bg-white flex items-center justify-center relative overflow-hidden min-h-[50vh] lg:min-h-screen">
        <div className="relative w-full h-full flex items-center justify-center">
          ...
          <div className="absolute" style={{ top: '12%', left: '55%' }}>
          ...
          <div className="absolute" style={{ top: '25%', left: '65%' }}>
          ...
          <div className="absolute" style={{ top: '40%', left: '10%' }}>
            <div className="w-12 h-12 rounded-full bg-gradient-to-r from-pink-500 to-yellow-500 flex items-center justify-center shadow-lg">
              <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center justify-center z-10">
            <div className="text-center">
              {/* Logo Icon */}
              <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-r from-[#8b1950] via-[#b33054] to-[#b73850] rounded-lg flex items-center justify-center shadow-lg">
                <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V8l8 5 8-5v10zm-8-7L4 6h16l-8 5z"/>
                </svg>
              </div>
              {/* Logo Text */}
              <h2 className="text-4xl font-bold text-[#8b1950] font-poppins logo-brand">
                minechat.ai
              </h2>
            </div>
          </div>
